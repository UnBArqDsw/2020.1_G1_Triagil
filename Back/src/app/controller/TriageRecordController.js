...
class TriageRecordController {
  async store(req, res) {
    ...
    if(triageRecord.headache){
      ...
      } else if((triageRecord.temperature_headache >= 35.00 && triageRecord.temperature_headache <= 37.8) || triageRecord.inconsciencia_headach ||
          triageRecord.diminuicao_visao || (triageRecord.pain_headache >= 4 && triageRecord.pain_headache <= 6) ||
          triageRecord.nausea_e_vomito){
